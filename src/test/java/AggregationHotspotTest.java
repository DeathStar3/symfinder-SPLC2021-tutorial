...
public class AggregationHotspotTest extends Neo4jTest {
    ...
    public void fiveVPsThresholdFive() {
        runTest(graph -> {
            ...
            graph.linkTwoNodes(vp1, vp2, RelationType.USE);
            graph.linkTwoNodes(vp1, vp3, RelationType.USE);
            graph.linkTwoNodes(vp2, vp4, RelationType.USE);
            graph.linkTwoNodes(vp3, vp5, RelationType.USE);
    ...
    public void fiveVPsThresholdTwo() {
        runTest(graph -> {
            ...
            graph.linkTwoNodes(vp1, vp2, RelationType.USE);
            graph.linkTwoNodes(vp3, vp4, RelationType.USE);
            graph.linkTwoNodes(vp2, v1, RelationType.USE);
            graph.linkTwoNodes(vp4, v1, RelationType.USE);
