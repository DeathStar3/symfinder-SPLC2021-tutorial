...
public class GetNodeTest extends Neo4jTest {
    ...
    @Test
    public void notGettingConstructorNodeWhenSearchingForAClassNode(){
        runTest(graph -> {
            Node rectangleClass = graph.createNode("shape.Rectangle", EntityType.CLASS);
            ...
            Optional <Node> foundNode = graph.getClassOrInterfaceNode("Rectangle");
            assertFalse(foundNode.isPresent());
        });
    }
