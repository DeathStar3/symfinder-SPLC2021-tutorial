...
/**
 * This filter removes nodes which do not use entry point classes, meaning that the graph will only show the entry point classes and other classes which use them.
 */
class EntryPointFilter extends NodesFilter {
    ...
    addFilterTitle(){
        if(this.filtersList.length === 0) {
            $(this.filtersListSelector).append('<h5 id="apiFilterTitle" style="text-align: center; font-weight: bold">Entry point classes filtered</h5>');
        }
    }
